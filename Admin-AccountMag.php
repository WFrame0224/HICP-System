			...
			<ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list tpl-header-list">
				<li class="am-dropdown" data-am-dropdown data-am-dropdown-toggle>
					...
					<ul class="am-dropdown-content">
						<li><a href="#"><span class="am-icon-bell-o"></span> 账户资料</a>
						</li>
						<li><a href="#"><span class="am-icon-cog"></span> 账户设置</a>
						</li>
					...
					<li class="tpl-left-nav-item">
						...
						<ul class="tpl-left-nav-sub-menu" style="display: block;">
							<li>
								...
								<a href="Admin-AccountMag.php" class="active">
								<i class="am-icon-angle-right"></i>
								<span>成员管理</span>
							</a>
			...
			<div class="tpl-block">
				<div class="am-g">
					<div class="am-u-sm-12">
						<iframe src="AccountMag.php" style="width:100%;height:800px" scrolling="no" seamless></iframe>
					</div>
				</div>
			</div>
		</div>
