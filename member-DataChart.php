			...
			<div class="tpl-block">
				<div class="am-g">
					<div class="am-u-sm-12">
						<iframe id="table1" src="DataTable1.php?relation=<?php echo $therelation?>" style="width: 600px;height:650px" scrolling="no" seamless></iframe>
						<iframe id="table2" src="DataTable2.php?relation=<?php echo $therelation?>" style="width: 600px;height:650px" scrolling="no" seamless></iframe>
					</div>
				</div>
			</div>
		</div>
