			...
			<ul class="tpl-left-nav-menu">
				...
				<li class="tpl-left-nav-item">
					...
					<ul class="tpl-left-nav-sub-menu" style="display: block;">
						<li>
							<a href="Admin-UsersGuide.php" class="active">
								<i class="am-icon-book"></i>
								<span>平衡训练</span>
							</a>
							<a href="Admin-UsersGuide.php" >
								<i class="am-icon-book"></i>
								<span>摸高训练</span>
							</a>
							<a href="Admin-UsersGuide.php" >
		...
		<div class="tpl-block">
			<div class="am-g">
				<div class="am-u-sm-12">
					<iframe class="content" src="BlanceGuide.php" frameborder="0" scrolling="yes" seamless></iframe>
				</div>
			</div>
		</div>
	</div>
